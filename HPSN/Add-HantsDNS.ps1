<#
Searches out the NICs with the local DNS (DC) IP set and adds the Hants DNS IP as an alternative.

v1.0 by Craig Webster
#>
...
Function Set-SecondaryDNS
{
    ...
    Set-DnsClientServerAddress -InterfaceIndex $InterfaceIndex  -ServerAddresses $DNSString -Verbose
