...
#Connect-SPOService -Url https://salisburyanglicanorg-admin.sharepoint.com
#$SiteURL = "https://salisburyanglicanorg-admin.sharepoint.com"

#Get-SPOSite | foreach {Get-SPOUser -Site $_.Url} | Where-Object -Property 'LoginName' -like *@salisbury.anglican.org
...
[cmdletbinding()]
    ...
    Try {
        #Connect to the Site - Omitted as called earlier in script (CW)
...
#$SiteURL="https://salisburyanglicanorg.sharepoint.com/sites/DBE"


#Call the function to generate permission report
Write-Host ("Entering loop block")
ForEach ($site in $Sites) {
    ...
    $ReportFile = $ReportDir + '\' + $SiteName + '-PermRpt.csv'

    Connect-PnPOnline -URL $site.Url -Interactive
    Write-Host -ForegroundColor Green ("Checking permissions for $SiteName...")
    Write-Host -ForegroundColor Green ("Report path is $ReportFile")
...
#Read more: https://www.sharepointdiary.com/2019/09/sharepoint-online-user-permissions-audit-report-using-pnp-powershell.html#ixzz7N9K5Rsx7